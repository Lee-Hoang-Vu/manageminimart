...
namespace QuanLySieuThi
{
    ...
    {
        public static string sqlcon = @"Data Source=HOANG-VU\HOANGVU;Initial Catalog=QLST;User ID=sa;Password=123;Connect Timeout=30";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                    ...
                    if (getRole == 0)
                {
                    ...
                    MessageBox.Show("Bạn đã đăng nhập bằng tài khoản admin", "Thông báo ", MessageBoxButtons.OK);
                    main2 a1 = new main2();
                ...
                {
                    MessageBox.Show("Bạn đã đăng nhập bằng tài khoản nhân viên", "Thông báo ", MessageBoxButtons.OK);
